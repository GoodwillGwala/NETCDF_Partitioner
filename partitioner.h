...
class Partitioner
{
    public:
        ...
        Partitioner(const string& filename, const string& varname, size_t step)
        : filename_(filename), varname_(varname), step_(step)
        {
    ...
    protected:
          ...
          // Get the total length of the 1D array associcated with the variable.
